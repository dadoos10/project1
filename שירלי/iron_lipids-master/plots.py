...
class Plots:
    ...
    #                          handler_map={tuple: Plots.MarkerHandler()}, loc=4)
    ...
    def plot(self):
        plt.plot(self.x_axis,self.y_axis,'o')
        m,b=np.polyfit(self.x_axis,self.y_axis,1)
        plt.plot(self.x_axis, m*self.x_axis+b)
        plt.title(self.title)
        plt.xlabel(self.x_label)
        plt.ylabel(self.y_label)
